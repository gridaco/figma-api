...
impl BooleanOperationNode {
    pub fn new(id: String, name: String, scroll_behavior: ScrollBehavior, blend_mode: models::BlendMode, children: Vec<models::SubcanvasNode>, fills: Vec<models::Paint>, effects: Vec<models::Effect>, boolean_operation: BooleanOperation) -> BooleanOperationNode {
