...
impl DefaultShapeTraits {
    pub fn new(id: String, name: String, scroll_behavior: ScrollBehavior, blend_mode: models::BlendMode, fills: Vec<models::Paint>, effects: Vec<models::Effect>) -> DefaultShapeTraits {
        DefaultShapeTraits {
            id,
            name,
            visible: None,
