...
impl RectangleNode {
    pub fn new(id: String, name: String, scroll_behavior: ScrollBehavior, blend_mode: models::BlendMode, fills: Vec<models::Paint>, effects: Vec<models::Effect>) -> RectangleNode {
        RectangleNode {
            id,
            name,
            visible: None,
