...
impl TransformGroupNode {
    pub fn new(id: String, name: String, scroll_behavior: ScrollBehavior, blend_mode: models::BlendMode, children: Vec<models::SubcanvasNode>, clips_content: bool, fills: Vec<models::Paint>, effects: Vec<models::Effect>) -> TransformGroupNode {
        TransformGroupNode {
            id,
            name,
            visible: None,
