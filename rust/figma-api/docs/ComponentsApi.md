...
> models::GetComponent get_component(key)
Get component
...
[**models::GetComponent**](GetComponent.md)
...
> models::GetFileComponents get_file_components(file_key)
Get file components
...
[**models::GetFileComponents**](GetFileComponents.md)
